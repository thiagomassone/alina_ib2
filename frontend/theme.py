...
visual definida por el equipo. Cualquier cambio de paleta se hace en un
único lugar.

Paleta:
    - NAVY        azul marino del logo (texto primario, marca)
    - TEAL        turquesa del logo (acento, métricas positivas, CTAs)
...
# Sombra reutilizable (alpha bajo sobre navy para que se vea integrada con la paleta)
SHADOW = "#0F2C4D14"
